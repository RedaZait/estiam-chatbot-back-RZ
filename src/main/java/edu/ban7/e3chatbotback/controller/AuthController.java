...
public class AuthController {
    ...
    public ResponseEntity<String> login(
            @RequestBody @Validated(AppUser.OnLogin.class) AppUser user
    ) {
        try {
            ...
            String jwt = Jwts.builder()
                    ...
                    .addClaims(Map.of(
                            "role",
                            userDetails.getUser().isAdmin() ? "admin" : "user"
                    ))
            ...
            return new ResponseEntity<>("Mauvais email ou mot de passe", HttpStatus.UNAUTHORIZED);
        }
    }
}